const Modal = () => {
	...
	if(state.pinSelected.metadata.link != undefined){
		...
		if(state.pinSelected.metadata.link.favicon != undefined){
			const infoFav = $("<img src='"+ state.pinSelected.metadata.link.favicon +"'>");
			divA.append(infoFav);
		}
	...
	// if(state.pinSelected.metadata.article.description != undefined){
	...
	// if(state.pinSelected.metadata.article.description != undefined){
	// 	descriptionAuthor = $("<p>"+ state.pinSelected.metadata.article.description +"</p>");
